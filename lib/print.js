...
function getColorScheme() {
  ...
  return {
    label: blue('#ff0795dc').bold,
    text: blue('#ff0795dc'),
    secondary: blue('#ff0795dc'),
    meta: blue('#ff0795dc'),
    bright: blue('#ff0795dc'),
    bold: chalk.bold,
    italic: chalk.italic,
    ...
    info: blue('#ff0795dc'),
    warning: blue('#ff0795dc'),
    error: blue('#ff0795dc'),
    success: blue('#ff0795dc')
  }
}

function getBorders(c) {
  return {
    top: `${c.secondary.bold('')}『 ${c.success.bold('𝐍𝚵𝑿𝐒𝐔𝐒 𝚩𝚯𝐓')} 』${c.secondary.bold('')}`,
